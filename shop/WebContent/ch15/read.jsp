...
<%
	  ...
	  BoardBean bean = bMgr.getBoard(num);// 게시물 정보 가져오기
	  ...
	  session.setAttribute("bean", bean);// 세션에 저장
%>
<!DOCTYPE html>
<html>
<head>
				...
				<table cellpadding="3" cellspacing="0" width="100%"> 
					...
					<tr> 
						...
						<td bgcolor="#FFFFE8" colspan="3">
							...
							<a href="javascript:down('<%=filename%>')"><%=filename%></a>&nbsp;&nbsp;<font color="blue">(<%=filesize%>KBytes)</font>  
							<%} else{%> 등록된 파일이 없습니다.<%}%>
						</td>
					</tr>
	   <tr> 
